        ...
        <div className="flex w-full md:w-3/4 mx-auto my-auto">
          <table className="w-full table-auto ">
            ...
            {currentFruits.map((fruit) => (
              <tbody
                key={fruit._id}
                className="text-sm font-normal text-gray-700 text-left divide-y"
              >
                <tr className="py-10 font-medium group hover:bg-[#10200b77]">
                  ...
                  <td className="px-4 py-4">
                    <div className="flex-col lg:flex-row lg:space-x-2 md:text-left text-center items-center space-y-2 lg:space-y-0">
                      <button
                        onClick={() => navigate("/dashboard/addFruit")}
                        className="items-center px-2 py-2 text-white bg-[#1c3a13] dark:bg-gray-500 rounded-md hover:bg-[#a58e0a] dark:hover:bg-gray-600 focus:outline-none"
                      >
                        <svg
                      ...
                      <button
                        ...
                        className="items-center px-2 py-2 text-white bg-red-500 dark:bg-gray-500 rounded-md hover:bg-red-800 dark:hover:bg-gray-600 focus:outline-none"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          className="h-4 w-4"
